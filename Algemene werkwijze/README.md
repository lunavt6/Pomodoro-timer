...
- De code voor de verschillende componenten werd eerst apart geschreven, zo kon van elk component de werking getest worden aan de hand van WokWi-simulaties en konden nodige functies geïdentificeerd worden, die componentafhankelijk waren. Hierbij werd gebruik gemaakt van librarys en wat in de lessen werd aangeleerd.
...
- De code van de LED's en de buzzer werd vervolgens samengevoegd, alsook degene van het scherm en de knoppen.
